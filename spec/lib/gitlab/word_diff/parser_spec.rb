  ...
  describe '#parse' do
    ...
    it 'returns a collection of lines' do
      ...
      aggregate_failures do
        ...
        expect(diff_lines.map { |line| diff_line_attributes(line) }).to match_array(
          [
            a_hash_including(index: 0, old_pos: 1, new_pos: 1, text: '', type: nil, marker_ranges: []),
            a_hash_including(index: 1, old_pos: 2, new_pos: 2, text: 'Unchanged line', type: nil, marker_ranges: []),
            a_hash_including(index: 2, old_pos: 3, new_pos: 3, text: '', type: nil, marker_ranges: []),
            a_hash_including(index: 3, old_pos: 4, new_pos: 4, text: 'Old changeNew addition unchanged content', type: nil,
                             marker_ranges: [
                               ...
                               Gitlab::MarkerRange.new(10, 21, mode: :addtion)
                             ]),
            ...
            a_hash_including(index: 5, old_pos: 50, new_pos: 50, text: 'First change same same same_removed_added_end of the line', type: nil,
                             marker_ranges: [
                               Gitlab::MarkerRange.new(0, 11, mode: :addtion),
                               Gitlab::MarkerRange.new(28, 35, mode: :deletion),
                               Gitlab::MarkerRange.new(36, 41, mode: :deletion)
                             ]),

            a_hash_including(index: 6, old_pos: 51, new_pos: 51, text: '', type: nil, marker_ranges: [])
          ]
        )
      end
    end
